    ...
    <ul class="menu-list">
      <li>
        <a href="{{route('admin.users.index')}}" class="{{Request::is('admin/users')?'is-active':''}}">
          <span class="icon"><i class="fa fa-users"></i></span><span>Users</span>
        </a>
      </li>

      <li>
        <a href="{{route('admin.channels.index')}}" class="{{Request::is('admin/channels')?'is-active':''}}">
          <span class="icon"><i class="fa fa-circle-o-notch"></i></span><span>Channels</span>
        </a>
      </li>

      <li>
        <a href="{{route('admin.discussions.index')}}" class="{{Request::is('admin/discussions')?'is-active':''}}">
          <span class="icon"><i class="fa fa-sticky-note"></i></span><span>Discussions</span>
        </a>
      </li>
