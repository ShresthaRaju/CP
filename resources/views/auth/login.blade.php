...
<div class="columns">
  <div class="column is-4 is-offset-4">
    <h1 class="title has-text-centered has-text-grey">Sign In</h1>
    <div class="card">
    ...
    <p class="has-text-grey-lighter has-text-centered m-t-20 ">New to discussion?
      <a href="{{route('register')}}" class="has-text-grey">Join Now</a>
    </p>
  </div>
</div>
@endsection
